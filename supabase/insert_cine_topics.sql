-- Insertar temas de cine en la categoría Cine
...
SELECT 
  unnest(ARRAY[
    ...
    '¿Por qué El nacimiento de una nación es importante para la historia del cine y a la vez profundamente polémica?',
  ...
  (SELECT id FROM categories WHERE name = 'Cine'),
  'improvisado'
ON CONFLICT DO NOTHING;

-- Verificar cuántos temas se insertaron
SELECT COUNT(*) as temas_cine_insertados 
FROM topics 
WHERE category_id = (SELECT id FROM categories WHERE name = 'Cine');
