-- Insertar temas de educación en la categoría Educación
...
SELECT COUNT(*) as temas_educacion_insertados 
FROM topics 
WHERE category_id = (SELECT id FROM categories WHERE name = 'Educación');
